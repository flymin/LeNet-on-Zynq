...
#
# Generated by export_simulation on Sat Dec 08 11:09:18 CST 2018
#
################################################################################
...
'-reset_run' switch to the './AXI_lite_0.sh' script.

./AXI_lite_0.sh -reset_run
...
./AXI_lite_0.sh -noclean_files

For more information on the script, please type './AXI_lite_0.sh -help'.
