...
#
# Generated by export_simulation on Sat Dec 08 11:05:56 CST 2018
#
################################################################################
...
'-reset_run' switch to the './AXI_FULL_S_0.sh' script.

./AXI_FULL_S_0.sh -reset_run
...
./AXI_FULL_S_0.sh -noclean_files

For more information on the script, please type './AXI_FULL_S_0.sh -help'.
